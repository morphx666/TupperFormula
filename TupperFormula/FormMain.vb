...
Public Class FormMain
    Private formulas As New List(Of TupperNumber) From {
                ...
                New TupperNumber("Matt was here", ""),
    ...
    Private Sub FormMain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        AddHandler ComboBoxFormulas.SelectedIndexChanged, Sub()
                                                              ignoreEvents = True
                                                              Dim index As Integer = ComboBoxFormulas.SelectedIndex
                                                              TextBoxNumber.Text = formulas(index).Number.ToString()
                                                              TextBoxNumber.SelectionStart = TextBoxNumber.Text.Length
                                                              CheckBoxInvertColors.Checked = formulas(index).InvertColors
                                                              CheckBoxFlipXY.Checked = formulas(index).FlipXY
                                                              ignoreEvents = False
                                                              UpdateTupperNumber()
                                                          End Sub
    ...
    Private Sub UpdateTupperNumber()
        ...
        hasErrors = False
        Try
            formulas(ComboBoxFormulas.SelectedIndex) = New TupperNumber(ComboBoxFormulas.Text,
                                                                        TextBoxNumber.Text,
    ...
    Private Sub UpdateBitmap()
        ...
        Dim formula As TupperNumber = If(hasErrors, New TupperNumber("", "0"), formulas(ComboBoxFormulas.SelectedIndex))
